...
from diffab.modules.rectified_flow.rectflow import RectFlowGenerator
...
class RectFlowAntibodyDesign(nn.Module):
    ...
    def forward(self, batch):
        ...
        loss_dict = self.rectflow_seq_only(
            ...
            pdbid=pdbid,fragment_type=batch['fragment_type']
        )
        return loss_dict
    ...
    def sample(
        ...
        traj = self.rectflow_seq_only.sample(R_0, p_0, s_0, res_feat,\
                                              pair_feat, mask_generate,\
                                                  ...
                                                  mask_template_generate=mask_template_generate,fragment_type=batch['fragment_type'],\
                                                      **sample_opt,batch_ref=batch,batch_id=batch_id,data_cropped=data_cropped,data_variant=data_variant,log_dir=log_dir,tag=tag)
        return traj
